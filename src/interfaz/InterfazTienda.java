...
public class InterfazTienda extends JFrame {
    ...
    public static void main(String[] pArgs) {
		...
		public void mostrarStockCritico() {
		    StringBuilder mensaje = new StringBuilder("Productos con stock crítico:\n");

		    // Se verifica cada producto para ver si está en stock crítico
		    ...
		    // Mostrar un mensaje si no hay productos en stock crítico
		    if (mensaje.toString().equals("Productos con stock crítico:\n")) {
		        mensaje = new StringBuilder("No hay productos en stock crítico.");
		    }

		    // Mostrar el mensaje al usuario
		    JOptionPane.showMessageDialog(this, mensaje.toString(), "Stock Crítico", JOptionPane.WARNING_MESSAGE);
		}
